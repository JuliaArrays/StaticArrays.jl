...
{
    "location": "index.html#Migrating-code-from-Julia-v0.6-to-Julia-v0.7-1",
    "page": "Home",
...
{
    "location": "pages/api.html#Base.similar-Union{Tuple{SA}, Tuple{SA}} where SA<:StaticArray",
    "page": "API",
    "title": "Base.similar",
    "category": "method",
...
{
    "location": "pages/api.html#LinearAlgebra.qr",
    "page": "API",
...
{
    "location": "pages/api.html#StaticArrays.sizematch-Union{Tuple{S2}, Tuple{S1}, Tuple{Size{S1},Size{S2}}} where S2 where S1",
    "page": "API",
...
{
    "location": "pages/api.html#StaticArrays.sizematch-Union{Tuple{S}, Tuple{Size{S},StaticArray}} where S",
    "page": "API",
    "title": "StaticArrays.sizematch",
    "category": "method",
