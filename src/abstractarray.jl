...
@inline similar{SA <: StaticArray}(::SA) = Ref{SA}()
@inline similar{SA <: StaticArray, T}(::SA, ::Type{T}) = Ref{similar_type(SA,T)}()
@inline similar{SA <: StaticArray}(::SA, sizes) = Ref{similar_type(SA,sizes)}()
@inline similar{SA <: StaticArray, T}(::SA, ::Type{T}, sizes) = Ref{similar_type(SA,sizes)}()
