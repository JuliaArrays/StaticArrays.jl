@testset "Core definitions and constructors" begin
    @testset "Inner Constructors" begin
        @test SArray{(1,),Int64,1,Tuple{Int64}}((1,)).data === (1,)
        @test SArray{(1,),Float64,1,Tuple{Float64}}((1,)).data === (1.0,)

        @test MArray{(1,),Int64,1,Tuple{Int64}}((1,)).data === (1,)
        @test MArray{(1,),Float64,1,Tuple{Float64}}((1,)).data === (1.0,)

        # default constructors
        @test_throws Exception SArray{(1,),Int64,1,Tuple{Int64}}()
    ...
    @testset "Type parameter errors" begin
        ...
        @test_throws Exception SArray{(1.0,),Int64,1,Tuple{Int64}}((1,))
        @test_throws Exception SArray{(1,),3,1,Tuple{Int64}}((1,))
        @test_throws Exception SArray{(1,),Int64,2,Tuple{Int64}}((1,))
        @test_throws Exception SArray{(1,),Int64,1,Tuple{Int64,Int64}}((1,))
        @test_throws Exception SArray{(1,),Int64,1,Tuple{Float64}}((1,))

        @test_throws Exception MArray{(1.0,),Int64,1,Tuple{Int64}}((1,))
        @test_throws Exception MArray{(1,),3,1,Tuple{Int64}}((1,))
        @test_throws Exception MArray{(1,),Int64,2,Tuple{Int64}}((1,))
        @test_throws Exception MArray{(1,),Int64,1,Tuple{Int64,Int64}}((1,))
        @test_throws Exception MArray{(1,),Int64,1,Tuple{Float64}}((1,))
    end
